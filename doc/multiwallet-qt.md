...
Only requiring some minor changes is smc-coin.cpp.
...
Changes to smc-coin.cpp
----------------------
smc-coin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
