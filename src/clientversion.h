...
//! These need to be macros, as clientversion.cpp's and smc-coin*-res.rc's voodoo requires it
...
/**
 * darknetd-res.rc includes this file, but it cannot cope with real c++ code.
