    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Smc-coin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Smc-coin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and smc-coin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Smc-coin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Smc-coin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Smc-coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Smc-coin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Smc-coin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Smc-coin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Smc-coin Core help message to get a list with possible Smc-coin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Smc-coin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Smc-coin network", "", count));
}
...
{
    QString strTitle = tr("Smc-coin Core"); // default title
