...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Smc-coin Core"),
     ...
     * override -datadir in the smc-coin.conf file in the default data directory
     * (to be consistent with darknetd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
