    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Smc-coin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Smc-coin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  smc-coin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Smc-coin Core is shutting down...") + "<br /><br />" +
